...
package com.jasperreporttest.employee.service;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    @Transactional(value = "employeeTransactionManager")
    @Override
	...
	@Transactional(readOnly = true, value = "employeeTransactionManager")
	@Override
	...
	@Transactional(rollbackFor = EntityNotFoundException.class, value = "employeeTransactionManager")
	@Override
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service employee for table Employee to {} format", exportType);
